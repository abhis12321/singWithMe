  ...
  return (
    <div className="w-full bg-gradient-to-b from-white to-slate-500 dark:from-slate-950 dark:to-slate-800 lg:text-red-900 dark:text-gray-300 font-semibold dark:font-medium flex items-center justify-between h-16 px-4 xm:px-8 overflow-hidden">
      ...
      <div className="right-navbar fixed lg:static top-0 right-0 hidden lg:flex gap-1 bg-gradient-to-r lg:[background:none] from-slate-800 to-slate-950 min-h-[100vh] lg:min-h-fit z-10 items-center min-w-[170px]">
        ...
        <div className="w-full lg:w-fit flex items-center justify-center"><Link href="/" className="w-full text-md flex items-center justify-center py-4 lg lg:py-2 lg:px-4 lg:rounded-lg hover:bg-slate-800 hover:text-white dark:hover:bg-gray-400/70 hover:lgshadow-[0_0_3px_gray]" >
          All songs
        </Link></div>

        <div className="w-full lg:w-fit flex items-center justify-center"><Link href="/bhakti" className="w-full text-md flex items-center justify-center py-4 lg lg:py-2 lg:px-4 lg:rounded-lg hover:bg-slate-800 hover:text-white dark:hover:bg-gray-400/70 hover:lgshadow-[0_0_3px_gray]" >
          Bhakti songs
        </Link></div>

        <div className="w-full lg:w-fit flex items-center justify-center"><Link href="/patriotic" className="w-full text-md flex items-center justify-center py-4 lg lg:py-2 lg:px-4 lg:rounded-lg hover:bg-slate-800 hover:text-white dark:hover:bg-gray-400/70 hover:lgshadow-[0_0_3px_gray]" >
          Patriotic songs
        </Link></div>

        <div className="w-full lg:w-fit flex items-center justify-center"><Link href="/contact" className="w-full text-md flex items-center justify-center py-4 lg lg:py-2 lg:px-4 lg:rounded-lg hover:bg-slate-800 hover:text-white dark:hover:bg-gray-400/70 hover:lgshadow-[0_0_3px_gray]" >
          Contact
        </Link></div>
