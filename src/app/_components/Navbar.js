...
export default function NavBar() {
  ...
  return (
    <div className="sticky top-0 left-0 z-[1000] w-full bg-white dark:bg-white/10 lg:text-red-900 dark:text-gray-300 flex items-center justify-between h-16 px-4 xm:px-8 overflow-hidden backdrop-blur-lg shadow-[0_0_1px_gray]">
      <div className="">
